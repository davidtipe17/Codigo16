...
const btnSearch = document.querySelector("#btn-search");
  const btnRestaurar = document.querySelector("#btn_limpiar1");
function createCards(arrayDeDatos) {
  ...
  <div class="card">
  <h4 class="title"> ${laptop.marca}</h4>
  <img
    src=${laptop.imagen}
    alt=""
    width="300"
  ...
  <div class="container-price">
    <p class="price">${laptop.precioOferta}</p>
    <p class="sale-price"${laptop.precioNormal}</p>
  </div>
